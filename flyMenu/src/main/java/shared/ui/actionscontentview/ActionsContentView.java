...
public class ActionsContentView extends ViewGroup {
  ...
  private static final String TAG = "beye";
  ...
  private final ActionsLayout viewActionsContainer; // menu layout
  private final ContentLayout viewContentContainer; //include frame layout containar
  ...
  public ActionsContentView(Context context, AttributeSet attrs, int defStyle) {
    ...
    final int actionsLayout = a.getResourceId(R.styleable.ActionsContentView_actions_layout, 0); // get int layout menu
    final int contentLayout = a.getResourceId(R.styleable.ActionsContentView_content_layout, 0); // get int layout container
...
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@//
    ...
    //@@@@@@@@@@@@@@ programaticly set and get fade @@@@@@@@@@@@@@/////
